...
{
show_debug_message("checking for STR")
	if (op==0){
		if (obj_player.str < value) {
			return true;
		}else{
			return false;
		}
...
{
if op==0{ if obj_player.spd < value {return true exit}else{return false exit} }//A < stat check
if op==1{ if obj_player.spd > value {return true exit}else{return false exit} }//A > stat check
}
