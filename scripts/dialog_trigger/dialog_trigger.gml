...
{
if op=0{obj_player.str+=value}//Adding
if op=1{obj_player.str+=-value}//Subtracting
if op=2{obj_player.str=value}//Setting
}

if string_contains(expression,"spd")
{
if op=0{obj_player.spd+=value}//Adding
if op=1{obj_player.spd+=-value}//Subtracting
if op=2{obj_player.spd=value}//Setting
}
